    ...
    <div className="min-h-screen bg-login-space text-slate-100 flex flex-col relative overflow-hidden font-sans select-none">
      ...
      <header className="w-full px-6 pt-6 pb-2 flex justify-start relative z-20">
        <div className="flex items-center gap-2.5">
          ...
          {/* Brand Name */}
          <h1 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-white via-emerald-300 to-teal-400 bg-clip-text text-transparent whitespace-nowrap leading-none flex items-center">
            Nishi Super Store
          </h1>
        </div>
      </header>
