          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="relative inline-block text-left">
              <button
                ...
                className="px-3.5 py-2.5 rounded-xl text-xs font-bold bg-zinc-900 border border-zinc-805 hover:border-emerald-500/50 hover:bg-zinc-900/60 text-zinc-300 hover:text-emerald-400 transition-all duration-300 cursor-pointer flex items-center gap-2"
              >
                <span>📂</span>
                <span className="hidden sm:inline">
                  Category: {
                    ...
                    selectedCategory === "dal" ? "Dal & Pulses" :
                    selectedCategory === "food" ? "Food Items" :
                    selectedCategory === "fruits" ? "Fruit Items" : "All Items"
                  }
                </span>
                <span className="sm:hidden">
                  {
                    ...
                    selectedCategory === "groceries" ? "Groceries" :
                    selectedCategory === "dal" ? "Dal" :
                    selectedCategory === "food" ? "Food" :
                    selectedCategory === "fruits" ? "Fruits" : "All"
                  }
                </span>
                <svg className={`w-3.5 h-3.5 transition-transform duration-300 ${isCategoryMenuOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {isCategoryMenuOpen && (
                <>
                  {/* Overlay layer to click outside and close */}
                  <div 
                  ...
                  {/* Dropdown Menu */}
                  <div className="absolute right-0 mt-2.5 w-60 bg-zinc-950/95 backdrop-blur-2xl border border-zinc-800 rounded-2xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.95)] p-2.5 z-20 space-y-1 animate-fadeIn">
                    {[
                      ...
                      <button
                        ...
                        className={`w-full px-4 py-3 rounded-xl text-xs font-bold transition-all duration-200 cursor-pointer flex items-center gap-2.5 text-left border ${
            ...
            <button
              ...
              className={`relative p-2.5 rounded-xl bg-zinc-900 border border-zinc-805 hover:border-emerald-500/50 hover:bg-zinc-900/60 transition-all duration-300 flex items-center gap-2 cursor-pointer active:scale-95 ${
