      ...
      <header className="w-full px-6 pt-6 pb-2 flex justify-start relative z-20">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col gap-0.5 text-left justify-center">
            <h1 className="text-xl font-extrabold tracking-tight bg-gradient-to-r from-white via-emerald-300 to-teal-400 bg-clip-text text-transparent whitespace-nowrap leading-none">
              Nishi Super Store
            </h1>
            <p className="text-[7px] text-emerald-400 font-bold tracking-wider uppercase mt-0.5">
              ✓ Fresh • Quality • Trusted
            </p>
          </div>
        </div>
